...
class DataSet(Dataset):
    def __init__(self, split='train'):
        if split == "train":
            fp_image = open('/Users/nhn/Desktop/mnist-hpo-practice/dataset/train-images-idx3-ubyte','rb')
            fp_label = open('/Users/nhn/Desktop/mnist-hpo-practice/dataset/train-labels-idx1-ubyte','rb')
        else:
            fp_image = open('/Users/nhn/Desktop/mnist-hpo-practice/dataset/t10k-images-idx3-ubyte','rb')
            fp_label = open('/Users/nhn/Desktop/mnist-hpo-practice/dataset/t10k-labels-idx1-ubyte','rb')
